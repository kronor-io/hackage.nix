{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/linear-locks-0.1.0.0-r0-e88329e7f40ca77eea33a57a69ca0e7d9e30ff1d35b86ba3873777e1653e0f3a.nix;
        revNum = 0;
        revTimestamp = "2026-05-11T10:40:12Z";
        sha256 = "e88329e7f40ca77eea33a57a69ca0e7d9e30ff1d35b86ba3873777e1653e0f3a";
      };
      default = "r0";
    };
  };
