{
  "0.1.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/algebraic-edge-graphs-0.1.0-r0-df69b2e9e40b37ccc16d87b5e1866da0182f0dcedd72a72195b4674b893da4af.nix;
        revNum = 0;
        revTimestamp = "2026-03-16T19:46:06Z";
        sha256 = "df69b2e9e40b37ccc16d87b5e1866da0182f0dcedd72a72195b4674b893da4af";
      };
      default = "r0";
    };
  };
  "0.1.1" = {
    ...
    revisions = {
      r0 = {
        ...
        revNum = 0;
        revTimestamp = "2026-04-27T18:42:54Z";
