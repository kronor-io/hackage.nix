{
  "1.0.0.0" = {
    ...
    revisions = {
      r0 = {
        ...
        revNum = 0;
        revTimestamp = "2026-07-11T00:13:35Z";
  ...
  "1.1.0.0" = {
    ...
    revisions = {
      r0 = {
        ...
        revNum = 0;
        revTimestamp = "2026-07-13T21:03:14Z";
  ...
  "1.2.0.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/pg-migrate-embed-1.2.0.0-r0-dd1766befb8774b16a6742bd0ba425091897a1705ac0885e1e84d6ef178f7bd6.nix;
        revNum = 0;
        revTimestamp = "2026-09-18T19:06:56Z";
        sha256 = "dd1766befb8774b16a6742bd0ba425091897a1705ac0885e1e84d6ef178f7bd6";
      };
      default = "r0";
    };
  };
