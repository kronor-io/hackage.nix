{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/settei-dhall-0.1.0.0-r0-429d92008cc452dca7317a56f53ca0a7d6d39e5d7e7fcae487492c0f71a2df07.nix;
        revNum = 0;
        revTimestamp = "2026-07-19T04:06:40Z";
        sha256 = "429d92008cc452dca7317a56f53ca0a7d6d39e5d7e7fcae487492c0f71a2df07";
      };
      default = "r0";
    };
  };
  "0.2.0.0" = {
    ...
    revisions = {
      r0 = {
        ...
        revNum = 0;
        revTimestamp = "2026-07-20T04:34:29Z";
