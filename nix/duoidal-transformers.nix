{
  "0.0.1.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/duoidal-transformers-0.0.1.0-r0-8e2b452cd962456bfff983725f574c104fc8a230bdde0a742539d5e74b2787b1.nix;
        revNum = 0;
        revTimestamp = "2025-11-17T20:25:34Z";
        sha256 = "8e2b452cd962456bfff983725f574c104fc8a230bdde0a742539d5e74b2787b1";
      };
      default = "r0";
    };
  };
