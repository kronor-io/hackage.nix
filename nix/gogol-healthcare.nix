{
  "0.5.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/gogol-healthcare-0.5.0-r0-0f12367d4f2ae274fe43155ed4e7910a6b5e8f71d77eaf605a4a8c914ba910d9.nix;
        revNum = 0;
        revTimestamp = "2019-08-23T07:39:04Z";
        sha256 = "0f12367d4f2ae274fe43155ed4e7910a6b5e8f71d77eaf605a4a8c914ba910d9";
      };
      default = "r0";
    };
  };
  "1.0.0" = {
    ...
    revisions = {
      r0 = {
        ...
        revNum = 0;
        revTimestamp = "2025-05-07T06:08:18Z";
