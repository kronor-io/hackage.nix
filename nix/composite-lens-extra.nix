{
  "0.0.1.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/composite-lens-extra-0.0.1.0-r0-4bde31667d262efbce64d4e322a50270ac6bf26072bbfff30f94fa424bf0fae4.nix;
        revNum = 0;
        revTimestamp = "2021-08-10T15:17:49Z";
        sha256 = "4bde31667d262efbce64d4e322a50270ac6bf26072bbfff30f94fa424bf0fae4";
      };
      default = "r0";
    };
  };
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        ...
        revNum = 0;
        revTimestamp = "2022-09-04T10:47:35Z";
