{
  "0.0.0.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/freckle-ecs-0.0.0.0-r0-66ec5f5094e6ee4d7ee2a64dec85bf96fff02853aed89a98e3b9db0e8f460bc8.nix;
        revNum = 0;
        revTimestamp = "2025-01-22T19:54:42Z";
        sha256 = "66ec5f5094e6ee4d7ee2a64dec85bf96fff02853aed89a98e3b9db0e8f460bc8";
      };
      default = "r0";
    };
  };
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        ...
        revNum = 0;
        revTimestamp = "2025-11-08T13:24:19Z";
