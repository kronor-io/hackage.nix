{
  "0.8" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/compdata-param-0.8-r0-a410c0ce2f9807a6582b13f3547e4ed6961965a1dc859202a764418a1d576797.nix;
        revNum = 0;
  ...
  "0.8.0.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/compdata-param-0.8.0.1-r0-ce6513a5ae2da908d4bf2fe75d30e3a216b11490d99da8af3e28da58eb56eddf.nix;
        revNum = 0;
  ...
  "0.8.0.2" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/compdata-param-0.8.0.2-r0-e5c22aa02b721af4daf61b1cba7399a265995d52836ae89cde07f5a53932bce4.nix;
        revNum = 0;
  ...
  "0.9" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/compdata-param-0.9-r0-0fc9e632de58bc3f4555377da3743d0522abd3aea4630b0cb184815564955787.nix;
        revNum = 0;
  ...
  "0.9.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/compdata-param-0.9.1-r0-5e9f6b730c3e9ea0e0ab0ac4f0f0b21b05fbb6013153662aa794f6a41b8225ac.nix;
        revNum = 0;
  ...
  "0.9.2" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/compdata-param-0.9.2-r0-bea4a831c004c06f2048134c5f63243f7106b28e2d7ac1fec6544f36e85b541e.nix;
        revNum = 0;
