{
  "0.1.0" = {
    ...
    revisions = {
      r0 = {
        ...
        revNum = 0;
        revTimestamp = "2024-03-15T03:13:48Z";
  ...
  "0.1.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/mt19937-0.1.1-r0-3a0f21f1e2e9e1d2e9d324d469c22d4a37b1cbf476a497aada2c77dff5888332.nix;
        revNum = 0;
        revTimestamp = "2024-07-14T19:18:32Z";
        sha256 = "3a0f21f1e2e9e1d2e9d324d469c22d4a37b1cbf476a497aada2c77dff5888332";
      };
      default = "r0";
    };
  };
