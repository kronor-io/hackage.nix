{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/spire-grpc-0.1.0.0-r0-c16f0460a6be0c289867f02fe34676efc8e6147b825fe6fe847194c8db842f8f.nix;
        revNum = 0;
        revTimestamp = "2026-04-28T00:17:40Z";
        sha256 = "c16f0460a6be0c289867f02fe34676efc8e6147b825fe6fe847194c8db842f8f";
      };
      default = "r0";
    };
  };
