{
  "1.4.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/ihp-ide-1.4.0-r0-dd781b8aa4faca15db7a788b456c3632a8d0ac99b25d04f49bec82930285fc8d.nix;
        revNum = 0;
        revTimestamp = "2025-08-31T16:24:21Z";
        sha256 = "dd781b8aa4faca15db7a788b456c3632a8d0ac99b25d04f49bec82930285fc8d";
      };
      default = "r0";
    };
  };
  "1.5.0" = {
    ...
    revisions = {
      r0 = {
        ...
        revNum = 0;
        revTimestamp = "2026-03-25T11:35:33Z";
