      ...
      tests = {
        ...
        "ghcide-tests" = {
          ...
          build-tools = [
            ...
            (hsPkgs.buildPackages.haskell-language-server.components.exes.ghcide-test-preprocessor or (pkgs.buildPackages.ghcide-test-preprocessor or (errorHandler.buildToolDepError "haskell-language-server:ghcide-test-preprocessor")))
      ...
      benchmarks = {
        "benchmark" = {
          ...
          build-tools = [
            ...
            (hsPkgs.buildPackages.eventlog2html.components.exes.eventlog2html or (pkgs.buildPackages.eventlog2html or (errorHandler.buildToolDepError "eventlog2html:eventlog2html")))
            ];
          buildable = true;
          };
        };
