    ...
    components = {
      ...
      tests = {
        "singletons-base-test-suite" = {
          ...
          build-tools = [
            (hsPkgs.buildPackages.singletons-base-code-generator.components.exes.singletons-base-code-generator or (pkgs.buildPackages.singletons-base-code-generator or (errorHandler.buildToolDepError "singletons-base-code-generator:singletons-base-code-generator")))
            ];
          buildable = true;
          };
        };
