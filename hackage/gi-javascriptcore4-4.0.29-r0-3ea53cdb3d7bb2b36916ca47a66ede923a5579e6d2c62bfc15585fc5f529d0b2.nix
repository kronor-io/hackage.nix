{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-javascriptcore4"; version = "4.0.29"; };
      ...
      url = "";
      synopsis = "JavaScriptCore 4.x bindings";
      description = "Bindings for JavaScriptCore 4.x, autogenerated by haskell-gi.";
      buildType = "Custom";
      setup-depends = [
