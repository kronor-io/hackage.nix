{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "bytestring"; version = "0.12.2.0"; };
    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "9.4") (hsPkgs."data-array-byte" or (errorHandler.buildDepError "data-array-byte"))) ++ (pkgs.lib).optional (system.isJavaScript || flags.pure-haskell) (hsPkgs."base" or (errorHandler.buildDepError "base"))) ++ (pkgs.lib).optional (system.isAarch64) (hsPkgs."base" or (errorHandler.buildDepError "base"));
