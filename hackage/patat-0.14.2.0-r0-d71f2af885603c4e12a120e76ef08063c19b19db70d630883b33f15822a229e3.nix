{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "patat"; version = "0.14.2.0"; };
    ...
    components = {
      ...
      tests = {
        ...
        "patat-goldplate" = {
          ...
          build-tools = [
            (hsPkgs.buildPackages.patat.components.exes.patat or (pkgs.buildPackages.patat or (errorHandler.buildToolDepError "patat:patat")))
            ];
          buildable = true;
          };
        };
